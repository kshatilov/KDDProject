...
2. How to execute:
   To run  subKMeans with wine dataset use following command:
        python main.py
   To use subKMeans with arbitrary dataset (as 2D array named X) in Python code use (similar to sklearn.kmeans):
...
5. The operating system, where program was tested:
   Windows 10 Home
